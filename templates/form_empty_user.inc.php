<div class="card-body">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="names" name="names" placeholder="First names ..." required>
  </div>
  <div class="form-group">
    <label for="last_names">Last names:</label>
    <input type="text" class="form-control" id="last_names" name="last_names" placeholder="Last names ..." required>
  </div>
  <div class="form-group">
