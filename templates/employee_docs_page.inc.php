      ...
      <div class="row">
        <div class="col-lg-6 col-6">
          <div class="card-documents card card-primary">
            ...
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/rfp/employee_docs/administration/';
              if (is_dir($directory)) {
        ...
        <div class="col-lg-6 col-6">
          <div class="card-documents card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-file"></i> RFP - Team</h3>
            </div>
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/rfp/employee_docs/rfp_team/';
              if (is_dir($directory)) {
                  $manager = opendir($directory);
                  echo '<div class="list-group">';
                  $folder = @scandir($directory);
                  ...
                  while (($file = readdir($manager)) !== false) {
                      ...
                      if ($file != "." && $file != "..") {
                          $file_url = str_replace(' ', '%20', $file);
                          echo '<li class="list-group-item">' . $file . '<a download href="' . EMPLOYEE_DOCS . 'rfp_team/' . $file_url . '" class="close float-right"><i class="fas fa-file-download"></i></a></li>';
                      }
                  }
                  closedir($manager);
                  echo "</div>";
