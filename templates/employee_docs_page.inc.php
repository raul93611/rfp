    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6 col-6">
          ...
          <div class="card-documents card card-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-file"></i> Brand</h3>
            </div>
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/rfp/employee_docs/brand/';
              if (is_dir($directory)) {
                  $manager = opendir($directory);
                  echo '<div class="list-group">';
                  $folder = @scandir($directory);
        ...
        <div class="col-lg-6 col-6">
          <div class="card-documents card card-primary">
            ...
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/rfp/employee_docs/accounting/';
              if (is_dir($directory)) {
                  $manager = opendir($directory);
                  echo '<div class="list-group">';
                  $folder = @scandir($directory);
