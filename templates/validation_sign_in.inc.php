...
if(isset($_POST['sign_in'])){
    ...
    if($validator-> valid_record()){
        $new_user = new User('', $validator-> get_username(), password_hash($validator-> get_password(), PASSWORD_DEFAULT), $validator-> get_names(), $validator-> get_last_names(), $level_user, $_POST['email']);
