      ...
      <div class="col-sm-12">
        <div class="form-group row">
          ...
          if (count($users)) {
            ...
            <div class="col-sm-10">
              <select id="designated_user" class="custom-select custom-select-sm" name="designated_user">
                <?php
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="custom-select custom-select-sm" name="business_type" id="business_type">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="custom-select custom-select-sm" name="priority" id="priority">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="custom-select custom-select-sm" name="submission_instructions" id="submission_instructions">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="custom-select custom-select-sm" name="subject" id="subject">
